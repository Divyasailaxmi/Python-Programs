...
source_path = '/home/divya/Desktop/Divya/philips07-12'
dest_path = source_path +"_aug/"

augment_list = ['rotate_90','flip_hr','flip_vr','contrast','brightness','rotate_180','noise']
...
if __name__ == "__main__":
    ...
    source_path = f'/home/divya/Desktop/Divya/philips07-12'
    dest_path = source_path +"_aug/"
    # "blend":blend,"rotate_90":rotate_90,"rotate_180":rotate_180,
    # 'rotate':rotate,'flip_hr':flip_hr,'flip_vr':flip_vr,'affine':move,'contrast':contrast,'resize':resize,'crop':crop,
    #             'brightness':brightness , "drop":dro'
    augment_list = ['rotate_90','flip_hr','flip_vr','contrast','brightness','rotate_180','noise']#,"brightness" ,'flip_hr','flip_vr','resize'
    p = pr(target=aug_img_bndbox,args=[source_path,dest_path,augment_list])
    p.start()
    p.join()
